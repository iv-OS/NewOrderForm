...
class OrderTableViewController: UITableViewController {
    ...
    func loadSampleOrders(){
        let order1 = Order(client: "Youman", unitPrice: 0.185, priceSold: 0.2755, quantity: 10000, screenH: 0, screenCharged: 0, house: 0, shipCo: 0, shipping: 0)
        orders.append(order1)
        
        let order2 = Order(client: "Parador", unitPrice: 0.53, priceSold: 1.00, quantity: 500, screenH: 0, screenCharged: 0, house: 0, shipCo: 0, shipping: 0)
